...
insert into employee_salary values(3,20000,3000,700,4000)
insert into employee_salary values(4,25000,3000,1000,2000)
...
insert into employee (employee_id,first_name,last_name,designation_id,department_id,salary_id,age,sex,active,half_yearly_grade) values(4,'Gaurav','Sharma',3,2,4,30,'M','True',4)
insert into employee (employee_id,first_name,last_name,designation_id,department_id,salary_id,age,sex,active,half_yearly_grade) values(5,'Adarsh','Gaur',4,1,5,60,'M','True',5)
